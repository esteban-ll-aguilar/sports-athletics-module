"""create_resultado_prueba_table_v3

Revision ID: 3ae175afd3b8
Revises: 
Create Date: 2026-01-21 00:30:23.342288
...
def upgrade() -> None:
    ...
    sa.Column('tipo_prueba', sa.String(), nullable=True),
    sa.Column('tipo_medicion', sa.String(), nullable=False),
    ...
    op.create_table('item_baremo',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('external_id', sa.Uuid(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('baremo_id', sa.Integer(), nullable=False),
    sa.Column('clasificacion', sa.String(), nullable=False),
    sa.Column('marca_minima', sa.Float(), nullable=False),
    sa.Column('marca_maxima', sa.Float(), nullable=False),
    sa.Column('estado', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['baremo_id'], ['baremo.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_item_baremo_external_id'), 'item_baremo', ['external_id'], unique=True)
    op.create_index(op.f('ix_item_baremo_id'), 'item_baremo', ['id'], unique=False)
    ...
    sa.Column('descripcion', sa.String(), nullable=False),
    sa.Column('asistio', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    sa.Column('atleta_confirmo', sa.Boolean(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_item_baremo_id'), table_name='item_baremo')
    op.drop_index(op.f('ix_item_baremo_external_id'), table_name='item_baremo')
    op.drop_table('item_baremo')
