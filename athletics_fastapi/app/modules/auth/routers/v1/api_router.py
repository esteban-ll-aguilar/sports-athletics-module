...
api_auth_router_v1.include_router(user_management_router_v1, prefix="/users", tags=["Admin Users"])
api_auth_router_v1.include_router(users_router_v1, prefix="/users", tags=["Users"])
