...
#Clase repositorio para gestionar operaciones de usuarios de autenticación
class AuthUsersRepository:
    ...
    # Método para obtener un usuario por su ID (UUID o string)
    ...
    # Método para activar un usuario por email
    ...
    async def update_password_by_email(self, email: str, new_password_hash: str) -> bool:
        ...
        if user:
            ...
            return True
        return False
    # Método privado para generar un código aleatorio
    async def _generate_code(length: int = 6) -> str:
        # Letras mayúsculas (y dígitos por robustez)
        alphabet = string.ascii_uppercase
        return "".join(random.choices(alphabet, k=length))
   
   #metodo privado para obtener el nombre de la columna de contraseña de una tabla de usuarios
