...
from app.modules.auth.domain.schemas.schemas_auth import UserCreate, UserRead
...
@representante_router.post("/athletes", response_model=UserRead, status_code=status.HTTP_201_CREATED)
...
@representante_router.get("/athletes", response_model=list[UserRead], status_code=status.HTTP_200_OK)
