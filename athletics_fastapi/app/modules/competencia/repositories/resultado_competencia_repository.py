...
class ResultadoCompetenciaRepository:
    ...
    async def get_by_id(self, id: int) -> ResultadoCompetencia | None:
    ...
    async def get_by_external_id(self, external_id: UUID) -> ResultadoCompetencia | None:
    ...
    async def get_by_atleta_and_competencia(self, atleta_id: int, competencia_id: int):
        """Obtener resultados de un atleta en una competencia."""
        result = await self.session.execute(
