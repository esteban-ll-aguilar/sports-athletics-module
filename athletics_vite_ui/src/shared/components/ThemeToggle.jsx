    ...
    return (
        <button
            ...
            className={`
                ...
                ${isDark
                    ? 'bg-gradient-to-br from-[#2a1a1f] to-[#1a0f14] text-amber-300 hover:from-[#3d2329] hover:to-[#2a1a1f] border border-[#b30c25]/20 shadow-lg shadow-[#b30c25]/10'
                    : 'bg-gradient-to-br from-white to-gray-50 text-orange-500 hover:from-orange-50 hover:to-white border border-gray-200 shadow-lg shadow-gray-200/50'}
                ${className}
            `}
        ...
        >
            ...
            <div 
                className={`
                    ...
                    ${isDark 
                        ? 'bg-gradient-to-br from-[#b30c25]/20 to-transparent' 
                        : 'bg-gradient-to-br from-orange-200/30 to-transparent'}
                `}
            />
