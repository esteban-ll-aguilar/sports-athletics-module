            ...
            <div className="border-b border-gray-800 bg-[#111] sticky top-0 z-20">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2 text-sm text-gray-400">
                        ...
                        <span className="text-white font-medium">Confirmación de Entrenamiento</span>
                    </div>
                    {/* Multi-record Indicator */}
                    {registro.length > 1 && (
                        <div className="flex items-center gap-2 bg-gray-800 rounded-full px-3 py-1">
                            <span className="text-xs text-gray-400">Sesión {recordIndex + 1} / {registro.length}</span>
                        </div>
                    )}
                </div>
            </div>
                    ...
                    {registro.length > 1 && (
                        <div className="flex items-center gap-3">
                            <button
                                onClick={prevRecord}
                                disabled={!hasPrev}
                                className={`w-12 h-12 rounded-full flex items-center justify-center border transition-all ${!hasPrev ? 'border-gray-800 text-gray-700 cursor-not-allowed' : 'border-gray-700 text-white hover:bg-gray-800 hover:border-gray-600'}`}
                            >
                            ...
                            <button
                                onClick={nextRecord}
                                disabled={!hasNext}
                                className={`w-12 h-12 rounded-full flex items-center justify-center border transition-all ${!hasNext ? 'border-gray-800 text-gray-700 cursor-not-allowed' : 'border-gray-700 text-white hover:bg-gray-800 hover:border-gray-600'}`}
                            >
