...
const Sidebar = () => {
    ...
    if (role && rolePermissions[role]) {
        ...
        // fallback: menú default por si algo falla
        menuItems.push(
            ...
            >
                ...
                <nav className="mt-6 px-2 space-y-2">
                    {menuItems.map((item) => (
                        <div
                            ...
                            className={`
                                cursor-pointer flex items-center px-4 py-3 rounded-lg transition-colors duration-200
                                ${isActive(item.path)
                ...
                <div className="absolute bottom-0 w-full border-t border-gray-200 p-4 bg-gray-50">
                    ...
                    <button
                        ...
                        className={`
                            mt-4 w-full flex items-center px-4 py-2 text-sm font-medium text-red-600 rounded-lg
