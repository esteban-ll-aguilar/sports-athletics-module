            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    {features.map((feature, index) => (
                        <motion.div
                            key={feature.title}
                            className="group bg-white dark:bg-[#242223] p-8 rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 dark:border-[#332122] transition-all duration-300"
                            variants={itemVariants}
                            whileHover={{ y: -8, transition: { duration: 0.2 } }}
                        >
                            <motion.div 
                                className="w-14 h-14 rounded-xl bg-[#b30c25]/10 flex items-center justify-center text-[#b30c25] mb-6 group-hover:bg-[#b30c25] group-hover:text-white transition-colors duration-300"
