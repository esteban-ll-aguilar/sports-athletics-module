            ...
            <div className="min-h-screen bg-[#111] p-6">
                <div className="max-w-7xl mx-auto">
                    <div className="animate-pulse">
                        <div className="h-8 bg-[#332122] rounded w-1/3 mb-4"></div>
                        <div className="h-64 bg-[#212121] rounded-2xl"></div>
                    </div>
                </div>
            </div>
        );
        ...
        <div className="min-h-screen bg-[#111] p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-400">Administra roles y permisos de usuarios</p>
                </div>

                {/* Filters */}
                <div className="bg-[#212121] rounded-2xl p-6 mb-6 border border-[#332122]">
                    <div className="flex flex-col md:flex-row gap-4 items-end">
                        <div className="flex-1">
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2 bg-[#121212] border border-[#332122] rounded-lg text-white focus:ring-2 focus:ring-[#b30c25]"
                            >
                        ...
                        <button
                            onClick={() => fetchUsers()}
                            disabled={loading}
                            className="px-4 py-2 bg-[#332122] hover:bg-[#402a2c] text-white rounded-lg transition-colors flex items-center gap-2"
                        >
                ...
                {/* Users Table */}
                <div className="bg-[#212121] rounded-2xl border border-[#332122] overflow-hidden">
                    {users.length === 0 ? (
                        ...
                        <>
                            ...
                            {/* Pagination */}
                            {pages > 1 && (
                                <div className="px-6 py-4 border-t border-[#332122] flex items-center justify-between">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            disabled={page === 1}
                                            className="px-3 py-1 bg-[#332122] hover:bg-[#402a2c] text-white rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            Anterior
                                        </button>
                                        <button
