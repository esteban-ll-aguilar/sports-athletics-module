...
| TC-03 | Validar Contraseña | POST /api/v1/auth/register | `{"password":"abc", ...}` | `{"success": false, "message": "Validation Error", "errors": [...]}` (Error de validación de contraseña) | | Fallido |
| TC-06 | Validar Rol Permitido | POST /api/v1/auth/register | `{"role":"ADMIN", ...}` | `{"success": false, "message": "Validation Error", "errors": [...]}` o 422 Unprocessable Entity | Rol ADMIN restringido | Fallido |
